...
$shop_details=
['shop_name' => '','address' => '','imglink' => '','description' => ''];

if(isset($_POST['submit'])){
	$shop_details['shop_name'] = $_POST['shop_name'];
	$shop_details['address'] = $_POST['address'];
	$shop_details['imglink'] = $_POST['imglink'];
	$shop_details['description'] = $_POST['description'];
	$shop_name =mysqli_real_escape_string($configconn,$_POST['shop_name']);
	...
	//create sql
	$sql = "INSERT INTO thebasics(shop_name,address,imglink,description) VALUES('$shop_name','$address','$imglink','$description')";
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter Shop name">
					<input class="input100" type="text" name="shop_name" placeholder="shop Name">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter Shop's address">
				...
				<div class="wrap-input100 validate-input" data-validate = "Please enter your description about the Shop">
