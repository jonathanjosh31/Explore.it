...
$sql = 'SELECT shop_name,address,imglink,created_at FROM clothing ORDER BY created_at';
...
<html lang="en">
  ...
  <?php include('essentials.php') ?>
    ...
    <title>Clothing and Brands</title>
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1462392246754-28dfa2df8e6b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px;">Shopping</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">Clothing and Brands</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
          ...
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <h1><?php echo htmlspecialchars($shop['shop_name']); ?></h1>
                            ...
                            <a class="btn" href="moreclothing.php?shop_name=<?php echo $shop['shop_name']?>">more</a>;
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addclothing.php">Add new Content</a>
