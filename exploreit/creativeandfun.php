...
$sql = 'SELECT place_name,address,imglink,created_at FROM creativeandfun ORDER BY created_at';
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px">Hangouts</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">Creative and fun</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
          ...
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <h1><?php echo htmlspecialchars($place['place_name']); ?></h1>
                            ...
                            <a class="btn" href="morecreativeandfun.php?place_name=<?php echo $place['place_name'];?>">more</a>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addcreativeandfun.php">Add new Content</a>
