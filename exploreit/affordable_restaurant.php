...
$sql = 'SELECT restaurant_name,address,imglink,created_at FROM affordable_restaurants ORDER BY created_at';
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1517359667188-dc53bf7c4c5d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px">Restaurants</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">Affordable Eating</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
        ...
        <?php foreach($restaurants as $restaurant): ?>  
          <div class="col-md-6">
            <div class="block">
            <div class="thumbnail">
              <img src="<?php echo htmlspecialchars($restaurant['imglink']) ?>" alt="" class="img-responsive">
              <div class="caption">
              <h1><?php echo htmlspecialchars($restaurant['restaurant_name']); ?></h1>
                            <p><?php echo htmlspecialchars($restaurant['address']); ?></p>
                            <a class="btn" href="moreaffordablerestaurants.php?restaurant_name=<?php echo $restaurant['restaurant_name'];?>">more</a>
              </div>
              </div>
            </div>
            </div>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addaffordablerestaurant.php">Add new Content</a>
