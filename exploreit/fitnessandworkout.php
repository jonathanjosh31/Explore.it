...
$sql = 'SELECT center_name,address,imglink,created_at FROM fitnessandworkout ORDER BY created_at';
...
<html lang="en">
  ...
  <?php include('essentials.php') ?>
    ...
    <title>Fitness and Workout</title>
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1521804906057-1df8fdb718b7?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px">Health and Fitness</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">Fitness and Workout</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
          ...
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <h1><?php echo htmlspecialchars($center['center_name']); ?></h1>
                            ...
                            <a class="btn" href="morefitnessandworkout.php?center_name=<?php echo $center['center_name'];?>">more</a>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addfitnessandworkout.php">Add new Content</a>
