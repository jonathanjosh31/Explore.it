...
$center_details=
['center_name' => '','address' => '','imglink' => '','description' => ''];

if(isset($_POST['submit'])){
	$center_details['center_name'] = $_POST['center_name'];
	$center_details['address'] = $_POST['address'];
	$center_details['imglink'] = $_POST['imglink'];
	$center_details['description'] = $_POST['description'];
	$center_name =mysqli_real_escape_string($configconn,$_POST['center_name']);
	...
	//create sql
	$sql = "INSERT INTO fitnessandworkout(center_name,address,imglink,description) VALUES('$center_name','$address','$imglink','$description')";
	//save to db and check
	if(mysqli_query($configconn,$sql)){
		//success
		header('Location:fitnessandworkout.php');
	}else{
		//error
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter center name">
					<input class="input100" type="text" name="center_name" placeholder="center Name">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter center address">
				...
				<div class="wrap-input100 validate-input" data-validate = "Please enter your description about the center">
