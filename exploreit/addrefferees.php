...
if(isset($_POST['submit'])){
	...
	//create sql
	$sql = "INSERT INTO refferees(institution_name,address,imglink,description) VALUES('$institution_name','$address','$imglink','$description')";
	//save to db and check
	if(mysqli_query($configconn,$sql)){
		//success
		header('Location:refferees.php');
	}else{
		//error
