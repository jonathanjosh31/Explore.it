...
$hotel_details=
['hotel_name' => '','address' => '','imglink' => '','description' => ''];

if(isset($_POST['submit'])){
	$hotel_details['hotel_name'] = $_POST['hotel_name'];
	$hotel_details['address'] = $_POST['address'];
	$hotel_details['imglink'] = $_POST['imglink'];
	$hotel_details['description'] = $_POST['description'];
	$hotel_name =mysqli_real_escape_string($configconn,$_POST['hotel_name']);
	...
	//create sql
	$sql = "INSERT INTO affordable_hotels(hotel_name,address,imglink,description) VALUES('$hotel_name','$address','$imglink','$description')";
	//save to db and check
	if(mysqli_query($configconn,$sql)){
		//success
		header('Location:affordable_hotels.php');
	}else{
		//error
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter hotel name">
					<input class="input100" type="text" name="hotel_name" placeholder="Hotel Name">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter hotel address">
				...
				<div class="wrap-input100 validate-input" data-validate = "Please enter your description about the hotel">
