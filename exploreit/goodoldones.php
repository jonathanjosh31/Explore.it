...
$sql = 'SELECT place_name,address,imglink,created_at FROM goodoldones ORDER BY created_at';
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1482245294234-b3f2f8d5f1a4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1430&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px">Hangouts</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">The Good Old Ones</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
        ...
        <?php foreach($places as $place): ?>
          <div class="col-md-4">
            <div class="block">
            <div class="thumbnail">
              <img src=" <?php echo htmlspecialchars($place['imglink']) ?>" alt="" class="img-responsive">
              <div class="caption">
              <h1><?php echo htmlspecialchars($place['place_name']); ?></h1>
                            <p><?php echo htmlspecialchars($place['address']); ?></p>
                            <a class="btn" href="moregoodoldones.php?place_name=<?php echo $place['place_name'];?>">more</a>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addgoodoldones.php">Add new Content</a>
