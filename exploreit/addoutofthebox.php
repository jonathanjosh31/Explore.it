...
$institution_details=
['institution_name' => '','address' => '','imglink' => '','description' => ''];

if(isset($_POST['submit'])){
	$institution_details['institution_name'] = $_POST['institution_name'];
	$institution_details['address'] = $_POST['address'];
	$institution_details['imglink'] = $_POST['imglink'];
	$institution_details['description'] = $_POST['description'];
	$institution_name =mysqli_real_escape_string($configconn,$_POST['institution_name']);
	...
	//create sql
	$sql = "INSERT INTO educationalinstitution(institution_name,address,imglink,description) VALUES('$institution_name','$address','$imglink','$description')";
	//save to db and check
	if(mysqli_query($configconn,$sql)){
		//success
		header('Location:outofthebox.php');
	}else{
		//error
		echo "<script>alert('This card already exists');<\script>";	
	}
}	
?>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter institution name">
					<input class="input100" type="text" name="institution_name" placeholder="institution Name">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter Institution's address">
				...
				<div class="wrap-input100 validate-input" data-validate = "Please enter your description about the Institution">
