...
$sql = 'SELECT shop_name,address,imglink,created_at FROM gettingdigital ORDER BY created_at';
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1519335553051-96f1218cd5fa?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=811&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px;">Shopping</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">Getting Digital</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
        ...
        <?php foreach($shops as $shop): ?>        
          <div class="col-md-6">
            <div class="block">
            <div class="thumbnail">
              <img src="<?php echo htmlspecialchars($shop['imglink']) ?>" alt="" class="img-responsive">
              <div class="caption">
              <h1><?php echo htmlspecialchars($shop['shop_name']); ?></h1>
                            <p><?php echo htmlspecialchars($shop['address']); ?></p>
                            <a class="btn" href="moregettingdigital.php?shop_name=<?php echo $shop['shop_name'];?>">more</a>
              </div>
              </div>
            </div>
            </div>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addgettingdigital.php">Add new Content</a>
