...
$sql = 'SELECT restaurant_name,address,imglink,created_at FROM newones ORDER BY created_at';
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1479044769763-c28e05b5baa5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px">Restaurants</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">New Ones</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
              ...
              <div class="block">
                <div class="thumbnail">
                    ...
                    <h1><?php echo htmlspecialchars($restaurant['restaurant_name']); ?></h1>
                            ...
                            <a class="btn" href="morenewones.php?restaurant_name=<?php echo $restaurant['restaurant_name'];?>">more</a>
                    </div>
                </div>
              </div>
            </div>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addnewones.php">Add new Content</a>
