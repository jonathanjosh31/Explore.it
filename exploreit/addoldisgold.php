...
$restaurant_details=
['restaurant_name' => '','address' => '','imglink' => '','description' => ''];

if(isset($_POST['submit'])){
	$restaurant_details['restaurant_name'] = $_POST['restaurant_name'];
	$restaurant_details['address'] = $_POST['address'];
	$restaurant_details['imglink'] = $_POST['imglink'];
	$restaurant_details['description'] = $_POST['description'];
	$restaurant_name =mysqli_real_escape_string($configconn,$_POST['restaurant_name']);
	...
	//create sql
	$sql = "INSERT INTO oldisgold(restaurant_name,address,imglink,description) VALUES('$restaurant_name','$address','$imglink','$description')";
	//save to db and check
	if(mysqli_query($configconn,$sql)){
		//success
		header('Location:oldisgold.php');
	}else{
		//error
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter Restaurant name">
					<input class="input100" type="text" name="restaurant_name" placeholder="Restaurant Name">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter Restaurant address">
				...
				<div class="wrap-input100 validate-input" data-validate = "Please enter your description about the Restaurant">
