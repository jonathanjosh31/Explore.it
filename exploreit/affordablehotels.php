...
$sql = 'SELECT hotel_name,address,imglink,created_at FROM affordable_hotels ORDER BY created_at';
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1444201983204-c43cbd584d93?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80 ');text-align: center; background-size: cover; position: relative;background-position: center;color: black; ">
          ...
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px;">Hotels and Lodges</h1>
              <h2 style="font-family: 'Open Sans', sans-serif;">Affordable</h2>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
          ...
          <div class="col-md-6">
            ...
            <div class="thumbnail">
              ...
              <h1><?php echo htmlspecialchars($hotel['hotel_name']); ?></h1>
                            ...
                            <a class="btn" href="moreaffordablehotels.php?hotel_name=<?php echo $hotel['hotel_name'];?>">more</a>
              </div>
              </div>
            </div>
            </div>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addaffordablehotels.php">Add new Content</a>
