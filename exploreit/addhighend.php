...
if(isset($_POST['submit'])){
	...
	//create sql
	$sql = "INSERT INTO high_hotels(hotel_name,address,imglink,description) VALUES('$hotel_name','$address','$imglink','$description')";
	//save to db and check
	if(mysqli_query($configconn,$sql)){
		//success
		header('Location:high_end_hotels.php');
	}else{
		//error
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter hotel name">
					<input class="input100" type="text" name="restaurant_name" placeholder="Hotel Name">
