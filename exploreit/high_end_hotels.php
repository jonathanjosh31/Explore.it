...
$sql = 'SELECT hotel_name,address,imglink,created_at FROM high_hotels ORDER BY created_at';
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1444201983204-c43cbd584d93?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80 ');text-align: center; background-size: cover; position: relative;background-position: center;color: black; ">
          ...
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px;">Hotels and Lodges</h1>
              <h2 style="font-family: 'Open Sans', sans-serif;">High End Hotels</h2>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
              ...
              <img src="<?php echo htmlspecialchars($hotel['imglink']) ?>" alt="" class="img-responsive">
                    <div class="caption">
                         <h1><?php echo htmlspecialchars($hotel['hotel_name']); ?></h1>
                            ...
                            <a class="btn" href="morehighend.php?hotel_name=<?php echo $hotel['hotel_name'];?>">more</a>
                    </div>
                </div>
            </div>
            </div>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addhighend.php">Add new Content</a>
