...
$sql = 'SELECT institution_name,address,imglink,created_at FROM refferees ORDER BY created_at';
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1503676260728-1c00da094a0b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=709&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px;">Educational Institutions</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">Referres</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
        ...
        <?php foreach($institutions as $institution): ?>
          <div class="col-md-4">
            <div class="block">
            <div class="thumbnail">
              <img src="<?php echo htmlspecialchars($institution['imglink']) ?>" alt="" class="img-responsive">
              <div class="caption">
              <h1><?php echo htmlspecialchars($institution['institution_name']); ?></h1>
                            <p><?php echo htmlspecialchars($institution['address']); ?></p>
                            <a class="btn" href="morereferees.php?institution_name=<?php echo $institution['institution_name'];?>">more</a>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addrefferees.php">Add new Content</a>
