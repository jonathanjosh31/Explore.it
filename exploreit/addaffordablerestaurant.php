...
if(isset($_POST['submit'])){
	...
	//create sql
	$sql = "INSERT INTO affordable_restaurants(restaurant_name,address,imglink,description) VALUES('$restaurant_name','$address','$imglink','$description')";
	//save to db and check
	if(mysqli_query($configconn,$sql)){
		//success
		header('Location:affordable_restaurant.php');
	}else{
		//error
