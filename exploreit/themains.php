...
$sql = 'SELECT institution_name,address,imglink,created_at FROM themains ORDER BY created_at';
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1491841550275-ad7854e35ca6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=667&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px;">Educational Institutions</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">The Mains</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
         ...
         <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <h1><?php echo htmlspecialchars($institution['institution_name']); ?></h1>
                            ...
                            <a class="btn" href="moremains.php?institution_name=<?php echo $institution['institution_name'];?>">more</a>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addthemains.php">Add new Content</a>
