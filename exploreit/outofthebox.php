...
$sql = 'SELECT institution_name,address,imglink,created_at FROM outofthebox ORDER BY created_at';
...
@media only screen and (max-width: 575px) {
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container-fluid" style="background-image:url('https://images.unsplash.com/photo-1465479423260-c4afc24172c6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80');text-align: center; background-size: cover; position: relative;background-position: center;color: white; ">
          <Br><br><br><br><br><br>    
          <h1 style="font-family: 'Open Sans', sans-serif;font-family: 'Arvo', serif; font-size: 50px;">Educational Institutions</h1>
              <h3 style="font-family: 'Open Sans', sans-serif;">Out of the Box</h3>
             <br><br><br><br><br><br>
             <br><br><br> 
        </div>
    <div class="container">
      <div class="featured-block">
          ...
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <h1><?php echo htmlspecialchars($institution['institution_name']); ?></h1>
                            ...
                            <a class="btn" href="moreoutofthebox.php?institution_name=<?php echo $institution['institution_name'];?>">more</a>
              </div>
              </div>
            </div>
            </div>
        ...
        <a class="btn" style="margin-left:160px;margin-right:auto;" href="addoutofthebox.php">Add new Content</a>
