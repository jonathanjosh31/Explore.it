...
if(isset($_POST['submit'])){
	...
	//create sql
	$sql = "INSERT INTO hospital(center_name,address,imglink,description) VALUES('$center_name','$address','$imglink','$description')";
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
				...
				<div class="wrap-input100 validate-input" data-validate="Please enter Hospital name">
					<input class="input100" type="text" name="center_name" placeholder="Hospital Name">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Please enter Hospital address">
				...
				<div class="wrap-input100 validate-input" data-validate = "Please enter your description about the Hospital">
